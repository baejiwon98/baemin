...
(function ($, M, CONFIG, window) {
  var page = {
    els: {
      $deliveryNameIpt: null,
      $deliveryPhoneIpt: null,
      $yearIpt: null,
      $monthIpt: null,
      $dateIpt: null,
      $nextBtn: null,
    ...
    data: {},
    init: function init() {
      this.els.$deliveryNameIpt = $('#delivery-name');
      this.els.$deliveryPhoneIpt = $('#delivery-phone');
    ...
    next: function () {
      var self = this;
      var name = this.els.$deliveryNameIpt.val().trim();
      var phone = this.els.$deliveryPhoneIpt.val().trim();
