/**
 * @file : orderList_employee_current.js
 * @author : 배지원
 * @date : 2022-04-17
 */
...
(function ($, M, window) {
  var page = {
    ...
    init: function init() {
      ...
      this.els.$changeBtn = $('#all-category-change');
      this.els.$topBtn = $('#top-btn');
    },

    initView: function initView() {
      $.sendHttp({
        path: "/api/payment/paymentStoreNow",
        data: {
    ...
    initEvent: function initEvent() {
      ...
      this.els.$changeBtn.on('click', function () {
        M.page.replace({
          url: "./eunjin_orderList_employee_all.html",
        });
      });
      ...
      $('#card').on('click', '.myOrderList', function () {
        ...
        M.page.html({
          url: './eunjin_userInfo_orderDetail_employee.html',
        });
      });
    } // end initEvent
  }; // end page
